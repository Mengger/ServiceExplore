...
public class SessionIdKey {
	
	private static String strDefaultKey = "JSESSION";
	 ...
	 * @throws Exception
	 */
	public SessionIdKey() throws Exception {
		this(strDefaultKey);
	}
	 ...
	 * @throws Exception
	 */
	public SessionIdKey(String strKey) throws Exception {
